...
import { fetchSubmissions, updateSubmissionStatus, deleteSubmission } from "@/lib/mockApi"
...
export default function ManagerDashboard() {
  ...
  const handleApprove = async (submission: ArtistSubmission) => {
    try {
      ...
      const response = await updateSubmissionStatus(submission.id, "approved")
  ...
  const handleReject = async (submission: ArtistSubmission) => {
    try {
      setActionLoading(submission.id)
      const response = await updateSubmissionStatus(submission.id, "rejected")
  ...
  const handleDelete = async (submission: ArtistSubmission) => {
    ...
    try {
      setActionLoading(submission.id)
      const response = await deleteSubmission(submission.id)
