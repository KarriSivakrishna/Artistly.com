...
/**
 * Global site footer
 * - Re-exported in layout folder so all new imports (`@/components/layout/Footer`)
 *   resolve without touching existing pages that still use `@/components/Footer`.
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              The fastest way to find and book amazing artists for your events. Connect with talented performers across
              all categories.
            </p>
          </div>
